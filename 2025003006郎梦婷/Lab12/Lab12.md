...
fun main() {
    val duration = measureTimeMillis {
        runBlocking {
            ...
            cookSteak()
            cookSalad()
            println("[${(System.currentTimeMillis() - startTime) / 1000.0}s] 全部完成，总耗时约 ${(System.currentTimeMillis() - startTime) / 1000.0} 秒")
        }
    }
}
...
fun main() {
    ...
    println("[${(System.currentTimeMillis() - startTime) / 1000.0}s] 全部完成，总耗时约 ${duration / 1000.0} 秒")
}
...
fun main() {
    val duration = measureTimeMillis {
        runBlocking {
            ...
            println("[${(System.currentTimeMillis() - startTime) / 1000.0}s] 加载完成，总耗时约 ${duration / 1000.0} 秒")
        }
    }
}
